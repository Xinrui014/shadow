...
if __name__ == "__main__":
    ...
    if opt['phase'] == 'train':
        ...
        with tqdm(total=n_epoch, unit='epoch') as pbar:
            ...
            while current_epoch < n_epoch+diffusion.begin_epoch:
                current_epoch += 1
                resume_epoch += 1
                ...
                if resume_epoch % 1 == 0:
                    ...
                    message = '<resume epoch:{:3d}, epoch:{:3d}, iter:{:8,d}> '.format(
                        resume_epoch, current_epoch, current_step)
                ...
                if resume_epoch % 20 == 0:
                    ...
                    for _,  val_data in enumerate(val_loader):
                        ...
                        fake_img = Metrics.tensor2img(visuals['INF'], min_max=(0, 1))  # uint8 before 0-1, the inf is same with lr
        ...
        for _,  val_data in enumerate(val_loader):
            ...
            if sr_img_mode == 'single':
                ...
                # grid img
                sr_img = Metrics.tensor2img(visuals['SR'])  # uint8
                test_img = Metrics.tensor2img(visuals['SR'][-1])
            ...
            avg_psnr += eval_psnr
            avg_ssim += eval_ssim
            # print(f"ID: {idx}; FILENAME: {filename}; PSNR: {eval_psnr}; SSIM: {eval_ssim}")
            logger_val = logging.getLogger('val')  # validation logger
